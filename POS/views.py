...
from POS.models import ShopCart, ShopCartForm, OrderForm, Order, OrderProduct
from PMS.models import Category, Product, Variants
...
def orderproduct(request):
    ...
    if request.method == 'POST':  # if there is a post
        ...
        if form.is_valid():
            ...
            ordercode= get_random_string(12).upper() # random cod
            data.code =  ordercode
            data.save() #
...
def payments(request):
    return HttpResponse('payments process')