...
from PMS.models import Product, Variants
...
class OrderForm(ModelForm):
    class Meta:
        model = Order
        fields = ['first_name','last_name','address','phone','email','city','country'] #,'email'
...
class PaymentMethods(models.Model):
    ...
    order = models.ForeignKey(Order, on_delete=models.CASCADE)
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    cash_on_delivery = models.CharField(max_length=50, blank=True)
    credit = models.CharField(max_length=50, blank=True)
    mpesa = models.CharField(max_length=50, blank=True)
